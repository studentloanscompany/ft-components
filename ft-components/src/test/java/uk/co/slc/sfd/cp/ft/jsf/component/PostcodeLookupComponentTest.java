...
public class PostcodeLookupComponentTest {

    private PostcodeLookupComponent testee;
    private FacesContext mockContext;
    @Mock
    private PostcodeLookupProvider mockPostcodeLookupProvider;
    ...
    public void setup() {
        ...
        testee = new PostcodeLookupComponent();
    ...
    /**
     * Test that when we search for a postcode that zero results an error is raised
    ...
    public void testSaveState() {
        ...
        assertTrue(stateArray.length == 4);
